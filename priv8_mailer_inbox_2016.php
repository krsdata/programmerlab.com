...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><meta content="1" name="revisit-after" /><style type="text/css">body {background:black url('http://www.ip-api.org/wp-content/uploads-images/tct.pnh.jpg') center right no-repeat; color:#FFFFFF; text-decoration:none; font-family:"Courier New", Courier, monospace; padding-left:200px; padding-top:200px; padding-right:300px; font-size:16px;}
	</style>
<title>.:|T.C.T|:.</title>
<style type="text/css">
.style1 {
...
<h1 class="auto-style2">.:|T.C.T xMailer |:.</h1>
...
sans-serif"><textarea name="message" rows="10" style="width: 455px" class="auto-style6"><?php echo($message); ?></textarea>&nbsp;<br class="auto-style3" />
			...
			<input type="button" id="prvbtn" value="Preview" onclick="prv()" style="width: 81px" class="auto-style6" /><input value="Rexa "SenD!" type="submit" class="auto-style6" /><span class="auto-style3">&nbsp;
