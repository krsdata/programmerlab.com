...
<footer class="dwqa-footer-share">
   <span class="dwqa-sharing">
        ...
        <ul>
            ...
            ?>
            <li><a target="_blank" href="https://www.facebook.com/sharer.php?u=<?php echo $permalink; ?>" class="dwqa-share-facebook " title="<?php _e('Share on Facebook','dwqa') ?>"><i class="fa fa-facebook"></i></a></li>
